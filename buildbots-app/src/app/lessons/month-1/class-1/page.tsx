...
import { Maximize2, Minimize2, ChevronLeft, ChevronRight, CheckCircle2, Play, Home } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#08121E] text-white flex flex-col selection:bg-cyan-500 selection:text-slate-950">
      ...
      <header className="h-16 bg-[#0B1829] border-b border-cyan-500/20 px-6 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-extrabold text-sm md:text-base leading-tight">Month 1 • Class 1: The Secret Inventor's Lab & Flashlight Discovery</h1>
